...
const BehaviorWellbeing: FC = () => {
    ...
    return (
      <div className="min-h-screen bg-[var(--bg-primary)] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[var(--text-primary)] text-lg">Memuat data perilaku & kesejahteraan...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)]">
      <Sidebar />
      <Header
        title="Analisis Perilaku & Kesejahteraan"
        subtitle="Kebiasaan keuangan, pola pengeluaran, dan faktor stres"
        ...
        <div className="glass-panel p-4 mb-6 relative z-10">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex gap-6">
              <div>
                <span className="text-sm text-[var(--text-secondary)]">Jumlah Responden Profil:</span>
            ...
            <div className="text-xs text-[var(--text-muted)]">
              ℹ️ Data perilaku dan kesejahteraan keuangan dari responden profil
            </div>
          </div>
        </div>
